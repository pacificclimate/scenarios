...
function init_map(map_id, region, climate_overlay, climate_time, color_range, color_scale, center_point, zoom_level) {
    ...
    addWMSLayer("Glaciers", 'cwb_glaciers_gwc', "http://medusa.pcic.uvic.ca:8080/geoserver/gwc/service/wms", null, null, null, null, true,  map.maxExtent.left + ',' + map.maxExtent.bottom);
    ...
    addWMSLayer("Land Cover", 'btmv1_landuse_gwc', "http://medusa.pcic.uvic.ca:8080/geoserver/gwc/service/wms", null, null, null, null, true,  map.maxExtent.left + ',' + map.maxExtent.bottom);
    addWMSLayer("Biogeoclimatic Zones", 'bec_zones_gwc', "http://medusa.pcic.uvic.ca:8080/geoserver/gwc/service/wms", null, null, null, null, true,  map.maxExtent.left + ',' + map.maxExtent.bottom);
