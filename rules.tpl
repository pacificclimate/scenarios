<div class="zoomable" id="<%rules_id%>">
  ...
  <div class="zoomwin">
    ...
    <div style="text-align: left; padding-left: 10px;">
      <h2>Rules</h2>
      <p>The table below lists a cleaned up version of all of the rules in use. Quite a bit of shorthand is used; this is described here. If not otherwise specified, fields are an interannual and spatial mean, and in standard units (degrees C for temperatures, mm/day for precipitation, etc).</p>

      <h3>Terminology</h3>
      <ul>
	<li>s0p/s50p/s100p = Minimum/median/maximum grid box value in the region.</li>
